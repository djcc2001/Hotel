...
public class MenuPrincipal extends JFrame {
	 ...
	 * Runnable() { public void run() { try { MenuPrincipal frame = new
	 * MenuPrincipal(); frame.setVisible(true); } catch (Exception e) {
	 * e.printStackTrace(); } } }); }
	 */
	...
	public MenuPrincipal() {
		...
		JLabel lblCopyR = new JLabel("Desarrollado por DJCC © 2023");
