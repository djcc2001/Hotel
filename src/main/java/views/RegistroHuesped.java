...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		txtNacionalidad.setModel(new DefaultComboBoxModel<String>(new String[] { "Seleccionar...", "afgano-afgana",
	...
	private void guardar() {
		...
		if (!RegistroHuesped.txtNombre.getText().isEmpty() && !RegistroHuesped.txtApellido.getText().isEmpty()
				...
				&& !RegistroHuesped.txtNacionalidad.getSelectedItem().equals("Seleccionar...")
				&& !RegistroHuesped.txtTelefono.getText().isEmpty()
				&& !RegistroHuesped.txtNreserva.getText().equals("0")) {
			...
			Huespedes huesped = new Huespedes(nombre, apellido, fechaN, nacion, tel, idReserva);
			boolean guardado = this.huespedesController.guardar(huesped);
			if (guardado) {
				dispose();
				Exito exito = new Exito(huesped.getIdReservas());
				exito.setVisible(true);
			} else {
				JOptionPane.showMessageDialog(null, "No se pudo guardar al huesped.");
			}
