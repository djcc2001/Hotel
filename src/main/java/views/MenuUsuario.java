...
public class MenuUsuario extends JFrame {
	 ...
	 * Runnable() { public void run() { try { MenuUsuario frame = new MenuUsuario();
	...
	public MenuUsuario() {
		...
		labelRegistro.setBounds(27, 11, 205, 34);
		...
		lblBusquedaDeReservas.setBounds(27, 11, 205, 34);
		...
		btnAddUser = new JPanel();
		btnAddUser.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnAddUser.setBackground(new Color(118, 187, 223));
			}

			@Override
			public void mouseExited(MouseEvent e) {
				btnAddUser.setBackground(new Color(12, 138, 199));
			}
		...
		btnAddUser.setBounds(0, 369, 257, 56);
		btnAddUser.setBackground(new Color(12, 138, 199));
		panelMenu.add(btnAddUser);
		btnAddUser.setLayout(null);

		JLabel lblAddUser = new JLabel("Agregar Usuario");
		lblAddUser.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/personaa.png")));
		lblAddUser.setBounds(27, 11, 205, 34);
		lblAddUser.setHorizontalAlignment(SwingConstants.LEFT);
		lblAddUser.setForeground(Color.WHITE);
		lblAddUser.setFont(new Font("Roboto", Font.PLAIN, 18));
		btnAddUser.add(lblAddUser);
