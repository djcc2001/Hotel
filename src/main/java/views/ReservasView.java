...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				Date fechaS = txtFechaSalida.getDate();

				if (fechaE != null && fechaS != null) {
					double valor = obtenerValor(fechaE, fechaS);
		...
		txtFormaPago.setModel(new DefaultComboBoxModel<String>(
				new String[] { "Seleccionar...", "Tarjeta de Crédito", "Tarjeta de Débito", "Dinero en efectivo" }));
		...
		JLabel labelSig = new JLabel("SIGUIENTE");
		labelSig.setHorizontalAlignment(SwingConstants.CENTER);
		labelSig.setForeground(Color.WHITE);
		labelSig.setFont(new Font("Roboto", Font.PLAIN, 18));
		labelSig.setBounds(0, 0, 122, 35);
		btnsiguiente.add(labelSig);
	...
	private void guardar() {
		...
		if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null
				&& !ReservasView.txtFormaPago.getSelectedItem().equals("Seleccionar...")) {
			...
			Reservas reserva = new Reservas(fechaE, fechaS, valor, formaPago);
			boolean guardado = this.reservasController.guardar(reserva);
			if (guardado) {
				dispose();
	...
	private double obtenerValor(Date fechaE, Date fechaS) {
		return reservasController.calcularValor(fechaE, fechaS);
	}
